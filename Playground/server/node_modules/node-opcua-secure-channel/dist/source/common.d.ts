...
import { ServiceFault } from "node-opcua-secure-channel/dist/source/services-secure-channel/dist/source/services";
export interface IResponseBase {
    responseHeader: ResponseHeader;
    schema: CommonInterface;
}
export declare type Response = IResponseBase | ServiceFault;
export interface IRequestBase {
    requestHeader: RequestHeader;
    schema: CommonInterface;
    securityMode: MessageSecurityMode;
}
export declare type Request = IRequestBase | CloseSecureChannelRequest;
